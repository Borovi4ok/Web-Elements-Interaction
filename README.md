...
+ test_dynamic_link - In this test, performed: click on a dynamic link, switch to the new window that it opens, and verification that the correct URL is displayed. Then, script switches back to the original window. This verifies the correct behavior of the dynamic link.
