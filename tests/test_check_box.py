...
class TestCheckBox(Assertions, ReusableFunctions):
    ...
    def test_screenshot_checkbox(self):
        # Should fail and generate screenshot
        text = self.driver.find_element(By.CLASS_NAME, "rct-title").text
        self.verify_equal(text, "Wrong text")
